...
The tool is developed and run directly from source; no wheel is built or
supported. A module is removable by deleting its complete package
...
and manifest is tracked. Removal means deleting the
