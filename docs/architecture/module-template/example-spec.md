...
| 1.3.0 | 2026-08-11 | Drop wheel delivery; source layout only |
...
Complete removal includes the package code, CLI, architecture, datasets, tests,
...
change: update the `module-test` selector and every neutral CLI boundary before
merge.
