...
- [`threat-model.md`](threat-model.md) — design-level threat model (v0.1.0 historical snapshot).
...
- [`worker-coldstart.md`](worker-coldstart.md) — worker cold-start benchmark: fork-per-task vs persistent pool.
