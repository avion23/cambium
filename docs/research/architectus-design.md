...
subtree/upward; IPC draft §§2.2/3/5/7; event draft catalog; design-deltas D2/D3;
...
| `ipc-protocol-draft.md` §§2.2/3/5/7 | steer gap and result/version proposals read. |
| `event-schema-draft.md` catalog | kind/tier mapping read; new kinds remain draft. |
| `costos-asyncio-design.md` §§3/5 | loop-affine WorkerHandle and writer handoff read. |
