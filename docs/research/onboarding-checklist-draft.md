...
and `docs/module-template/*`. The normative docs were originally read on branch `wt-arch`
...
> **Template caveat.** `agents.md`, `docs/architecture.md` (v2.0.0), and
> `docs/module-template/*` are now in `main` (merged as commit `18128a6`); the reference
